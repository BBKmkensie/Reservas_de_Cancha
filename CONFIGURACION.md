...
1. **DB_HOST**: Dirección IP del servidor MariaDB (por defecto: 127.0.0.1 para localhost)
2. **DB_PORT**: Puerto de MariaDB (por defecto: 3306)
3. **DB_USERNAME**: Usuario de la base de datos (por defecto: root)
4. **DB_PASSWORD**: Contraseña de la base de datos (deja vacío si no tienes contraseña)
...
1. MariaDB esté corriendo en tu sistema
